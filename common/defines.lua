...
country = {
	...
	GOLD_TO_CASH_RATE = 0.1, -- 金矿价值 Amount of money generated per gold unit
...
economy = {
	...
	TRADE_CAP_LOW_LIMIT_LAND = 0.7, 			-- 最低开支70% the lowest % the slider can go for land units
	TRADE_CAP_LOW_LIMIT_NAVAL = 0.7, 			-- 最低开支70% the lowest % the slider can go for naval units
